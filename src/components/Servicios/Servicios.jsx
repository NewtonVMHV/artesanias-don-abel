const Servicios = () =>{
    return(
        <section className="bg-white dark:bg-gray-900" id="Servicios">
            <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                <div className="max-w-screen-md mb-8 lg:mb-16">
                    <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Tenemos los siguientes servicios</h2>
                    <p className="text-gray-500 sm:text-xl dark:text-gray-400">Nosotros presentamos la mejor calidad con el mejor servicio que se puede dar a nuestros clientes.</p>
                </div>
                <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                    <div>
                        ...
                        <h3 className="mb-2 text-xl font-bold dark:text-white">Servicio al cliente</h3>
                        <p className="text-gray-500 dark:text-gray-400">Ofrecemos el servicio al cliente acuerdo a la petición de nuestro cliente.</p>
                    </div>
                    <div>
                        <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                        ...
                        <h3 className="mb-2 text-xl font-bold dark:text-white">Decoraciones</h3>
                        <p className="text-gray-500 dark:text-gray-400">Ofrecemos las decoraciones para el interior de sus hogares o eventos.</p>
                    </div>
                    <div>
                        <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                        ...
                        <h3 className="mb-2 text-xl font-bold dark:text-white">Cotizaciones</h3>
                        <p className="text-gray-500 dark:text-gray-400">Cuando es venta para un evento o por mayoreo se puede cotizar el precio total acuerdo a la petición del cliente.</p>
                    </div>
                </div>
            </div>
        </section>
