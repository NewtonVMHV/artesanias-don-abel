        ...
        <section className="bg-white" id="Servicios">
            <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                <div className="max-w-screen-md mb-8 lg:mb-16">
                    <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900">Tenemos los siguientes servicios</h2>
                ...
                <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                    <div>
                        ...
                        <h3 className="mb-2 text-xl font-bold">Servicio al cliente</h3>
                    ...
                    <div>
                        ...
                        <h3 className="mb-2 text-xl font-bold">Decoraciones</h3>
                    ...
                    <div>
                        ...
                        <h3 className="mb-2 text-xl font-bold">Cotizaciones</h3>
